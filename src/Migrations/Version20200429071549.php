 ...
 */
final class Version20200429071549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP nom, DROP prenom, CHANGE mot_de_passe mot_de_passe VARCHAR(255) NOT NULL, CHANGE adresse_mail adresse_mail VARCHAR(180) NOT NULL');
